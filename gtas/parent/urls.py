...
from gtas.parent.views.views import DashView
...
urlpatterns = [
    ...
    # path('airport_restore', AirportRestoreCRUDView.as_view(), name='airport_restore_crud'),
    path('api_access', ApiAccessCRUDView.as_view(), name='api_access_crud'),
    path('app_configuration', AppConfigurationCRUDView.as_view(), name='app_configuration_crud'),
    path('audit_log', AuditLogCRUDView.as_view(), name='audit_log_crud'),
    path('carrier', CarrierCRUDView.as_view(), name='carrier_crud'),
    # path('carrier_restore', CarrierRestoreCRUDView.as_view(), name='carrier_restore_crud'),
    path('code_share_flight', CodeShareFlightCRUDView.as_view(), name='code_share_flight_crud'),
    path('country', CountryCRUDView.as_view(), name='country_crud'),
    # path('country_restore', CountryRestoreCRUDView.as_view(), name='country_restore_crud'),
